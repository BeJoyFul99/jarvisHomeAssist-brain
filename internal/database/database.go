...
func Migrate(db *gorm.DB, log *applogger.Logger) error {
	if err := db.AutoMigrate(&models.User{}, &models.RefreshToken{}, &models.AuditLog{}, &models.WifiNetwork{}, &models.SmartDevice{}, &models.EnergyReading{}, &models.EnergyRate{}, &models.EnergyBudget{}, &models.Setting{}, &models.ChatRoom{}, &models.ChatMessage{}, &models.ChatReadReceipt{}, &models.Notification{}, &models.PushSubscription{}, &models.Announcement{}, &models.AnnouncementRead{}, &models.Property{}, &models.UtilityBill{}, &models.UtilityBillLineItem{}); err != nil {
